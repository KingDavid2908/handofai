...
export namespace Flag {
  ...
  export const OPENCODE_ENABLE_TINYFISH =
    truthy("OPENCODE_ENABLE_TINYFISH") || OPENCODE_EXPERIMENTAL || truthy("OPENCODE_EXPERIMENTAL_TINYFISH")
  export const OPENCODE_ENABLE_TAVILY =
    truthy("OPENCODE_ENABLE_TAVILY") || OPENCODE_EXPERIMENTAL || truthy("OPENCODE_EXPERIMENTAL_TAVILY")
  export const OPENCODE_ENABLE_FIRECRAWL =
    truthy("OPENCODE_ENABLE_FIRECRAWL") || OPENCODE_EXPERIMENTAL || truthy("OPENCODE_EXPERIMENTAL_FIRECRAWL")
