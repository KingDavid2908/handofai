...
import { BunFileSystem, BunSink, BunStream } from "@effect/platform-bun"
...
export const defaultLayer = layer.pipe(Layer.provide(BunFileSystem.layer), Layer.provide(BunPath.layer))
